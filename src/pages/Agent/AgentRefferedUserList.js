...
import { getRefferedUserListServ } from "../../services/agent.service";
...
function AgentRefferedUserList() {
  ...
  const getUserListFunc = async()=>{
    ...
    try {
      let response = await getRefferedUserListServ({agent_id:params?.id});
  ...
  return (
    <div className="main_layout  bgBlack d-flex">
      ...
      <section className="section_layout" style={{ marginLeft :globalState?.isFillSidebarWidth100 ? "260px": "80px" }}>
        ...
        {/* table List started */}
        <div className="">
          <TableNav tableNav={tableNav} selectedItem="User App" sectedItemBg="#DFD7FF" />
...
export default AgentRefferedUserList;
