...
function DriveCancelledBooking() {
    ...
    <div className="main_layout  bgBlack d-flex">
      ...
      <section className="section_layout" style={{minWidth:"1350px",  marginLeft :globalState?.isFillSidebarWidth100 ? "260px": "80px" }}>
        ...
        <div className="tableMain">
          ...
          <div className="tableBody py-2 px-4 borderRadius50expectTopRight" style={{ background: "#363435" }}>
...
export default DriveCancelledBooking;
