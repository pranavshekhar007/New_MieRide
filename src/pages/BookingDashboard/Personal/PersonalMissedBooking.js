                                ...
                                <div className="row">
                                  <div className="col-6">
                                    <button
                                      ...
                                      onClick={() => reasignBtnLoader!=value?.id ? handleReasignDriver(value?.id) : {}}
                                      style={{opacity:reasignBtnLoader == value?.id ? "0.5":"1"}}
                                    >
                                      <div className="d-flex justify-content-around align-items-center">
                                        <div>{reasignBtnLoader == value?.id ? "Re-assigning ... ":"Re-assign" } </div>
                                      </div>
                                    </button>
                                  </div>
                                  <div className="col-6">
                                    <button
                                      className="sharingRouteButton w-100"
                                      onClick={() =>
                                        continueBtnLoader!=value?.id ? handleContinueWithSameDriver(value?.id) : {}
                                       
                                      }
                                       style={{opacity:continueBtnLoader == value?.id ? "0.5":"1"}}
                                    >
                                      <div className="d-flex justify-content-around align-items-center">
                                        <div> {continueBtnLoader == value?.id ? "Sending ... ":"Continue" } </div>
                                      </div>
                                    </button>
                                  </div>
                                </div>
