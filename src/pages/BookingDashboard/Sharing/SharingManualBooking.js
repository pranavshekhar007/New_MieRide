...
function SharingManualBooking() {
  ...
  const handleGetListFunc = async () => {
    ...
    try {
      let response = await getManualBookingRecordServ(payload);
                      ...
                      >
                        ...
                        <div className="row mt-4">
                          <div className="col-4">
                              ...
                              <div className="d-flex">
                                <div className="w-50 pe-2">
                                  <button
                                    onClick={() =>
                                      navigate(
                                        `/sharing-select-avilability-driver/${value?.group_id}`
                                      )
                                    }
                                  >
                                    Assign Driver
                            ...
                            <button
                              onClick={() => addGroupToManualFunc(value?.id)}
                            >
                              Send to Manual
                            </button>
                          )} */}
                    ...
                    <div className="managepopupgroupleft mt-4 ms-2">
                      <div className="mb-3">
                        <button
                          ...
                          disabled={!selectedBooking || unLinkLoader} // 👈 Disable logic
                          style={{
                      ...
                      <div>
                        <button
                          className="shiftButton"
                          disabled={!selectedBooking || cancelLoader} // 👈 Disable logic
                          style={{
        ...
        <div className="tableMain">
          {showSkelton
            ...
            : list?.map((value, i) => {
                return (
                  <div
                    className={"tableBody py-3 px-4 borderRadius30All"}
                            ...
                            >
                              <div className="col-12">
                                <button
                                  ...
                                  onClick={() =>
                                    navigate(
                                      "/sharing-select-avilability-driver/" +
                                        value?.group_id
                                    )
                                  }
                                >
...
export default SharingManualBooking;
