...
import {
  getMissedBookingRecordServ,
  continueWithSameDriverServ,
  reassignDriverForMissedBookingServ,
...
function SharingMissedBooking() {
  ...
  const handleGetListFunc = async () => {
    ...
    try {
      let response = await getMissedBookingRecordServ(payload);
  ...
  const handleReassignFunc = async (id) => {
    try {
      let response = await reassignDriverForMissedBookingServ({ group_id: id });
      if (response?.data?.statusCode == "200") {
                            ...
                            <div className="routeLeftCard mt-4">
                              ...
                              <div className="row ">
                                <div className="col-3">
                                  <button
                                    onClick={() =>
                                      handleReassignFunc(value?.group_id)
                                    }
                                  >
                                    Re-Assign
                                  </button>
                                  ...
                                  <div className="row m-0 p-0 h-100">
                                    ...
                                    <div className="col-3 h-100 d-flex justify-content-center align-items-center">
                                      <div className="d-flex align-items-center routeLocationDiv">
                                        ...
                                        />
                                        <p>
                                          {v?.place_name?.length > 33
                                            ? v?.place_name?.substring(0, 30) +
                                              "..."
                                            : v?.place_name}
                                        </p>
                                      </div>
              ...
              <div className="modal-body tipPopUpBody" style={{padding:" 30px"}}>
                ...
                >
                  <div className="w-100">
                    ...
                    <div className="missiedPopupRadioGroup mb-5">
                      <label>
                        <input
                          type="radio"
                          name="status"
                        ...
                        >
                          <div className="w-100 ">
                            <div className="row">
                              ...
                              <div className="col-4 mb-3">
                                <p style={{ color: "#000" }}>Confirmed Time</p>
                                <h3 style={{ color: "#000" }}>
                                  {moment(value?.accept_time).format("hh:mm A")}
                                </h3>
                              </div>
...
export default SharingMissedBooking;
