              ...
              <table className="table bookingTable outOfArea">
                <thead>
                  <tr style={{ background: "#D0FF13", color: "#000" }}>
                    ...
                    <th scope="col">Day Since Updated</th>
                    <th
                      scope="col"
                          ...
                          <>
                            <tr className="bg-light mb-2">
                              ...
                              <td><button
                                    ...
                                    style={{ background: "#1C1C1E" , width:"154px", fontSize:"12px", fontWeight:"400"}}
                                  >
                                    <span>Ride Status - Booked</span>
                                  </button></td>
                              <td>{v?.title}</td>
                              <td>{v?.message}</td>
                              <td>
...
export default BroadcastDriverFixed;
