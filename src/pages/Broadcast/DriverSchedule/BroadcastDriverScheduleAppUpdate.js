...
function BroadcastDriverScheduleAppUpdate() {
  ...
  const tableNav = [
    ...
    },
    {
      ...
      path: "/broadcast-driver-schedule-booking-personal",
    },
    {
      name: "Deals",
      path: "/broadcast-driver-schedule-deals",
    },
    {
      name: "Holidays",
      path: "/broadcast-driver-schedule-holidays",
    },
    {
      name: "App Update",
      path: "/broadcast-driver-schedule-app-update",
    },

    {
      name: "Maintenance",
      path: "/broadcast-driver-schedule-maintenance",
    },
  ];
      ...
      >
        ...
        <div className="sticky-top bg-light" style={{ paddingTop: "45px" }}>
          ...
          <BroadcastNotificationNav
            ...
            selectedItem="App Update"
            sectedNavBg="#353535"
            selectedNavColor="#fff"
            isItemMoreThen8={true}
            payload={{user_type:"driver", type:"app_updates", category:"scheduled",}}
            ...
            >
              <div className="modal-body p-0" style={{ fontFamily: "poppins" }}>
                ...
                >
                  ...
                  >
                    <p className="text-center">Edit Driver Notification</p>
                  </div>
                </div>
                <div className="notificationFormContent">
                  <div className="d-flex justify-content-between">
                    <div className="categorySelectedDiv">App Update</div>
...
export default BroadcastDriverScheduleAppUpdate;
