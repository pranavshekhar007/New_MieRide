...
function BroadcastDriverScheduleBookingPersonal() {
      ...
      >
        ...
        <div className="sticky-top bg-light" style={{ paddingTop: "45px" }}>
          ...
          <BroadcastNotificationNav
            ...
            payload={{user_type:"driver", type:"personal_booking", category:"scheduled",}}
...
export default BroadcastDriverScheduleBookingPersonal;
