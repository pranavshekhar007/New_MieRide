...
function BroadcastDriverScheduleBookingSharing() {
      ...
      >
        ...
        <div className="sticky-top bg-light" style={{ paddingTop: "45px" }}>
          ...
          <BroadcastNotificationNav
            ...
            payload={{user_type:"driver", type:"sharing_booking", category:"scheduled",}}
...
export default BroadcastDriverScheduleBookingSharing;
