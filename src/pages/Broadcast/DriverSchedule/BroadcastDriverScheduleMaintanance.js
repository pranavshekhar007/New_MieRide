...
function BroadcastDriverScheduleMaintanance() {
      ...
      >
        ...
        <div className="sticky-top bg-light" style={{ paddingTop: "45px" }}>
          ...
          <BroadcastNotificationNav
            ...
            payload={{user_type:"driver", type:"maintenance", category:"scheduled",}}
              ...
              <div className="modal-body p-0" style={{ fontFamily: "poppins" }}>
                ...
                <div className="notificationFormContent">
                  <div className="d-flex justify-content-between">
                    <div className="categorySelectedDiv">Maintenance</div>
...
export default BroadcastDriverScheduleMaintanance;
