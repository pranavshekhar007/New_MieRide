...
function BroadcastUserScheduleBookingSharing() {
  ...
  const handleUpdateNotification = async () => {
   ...
   return(
    <div className="mainBody">
      <NewSidebar selectedItem="Broadcast Manager" />
      ...
      >
        ...
        <div className="sticky-top bg-light" style={{ paddingTop: "45px" }}>
          ...
          <BroadcastNotificationNav
            ...
            payload={{user_type:"user", type:"sharing_booking", category:"scheduled",}}
...
export default BroadcastUserScheduleBookingSharing;
