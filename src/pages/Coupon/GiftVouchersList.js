              ...
              <div className="row my-4">
                ...
                <div className="col-3">
                  <button
                    ...
                    style={{ background: "#139F01", borderRadius: "20px" , opacity:"0.4"}}
                        ...
                        return (
                          <>
                            <tr className="bg-light mb-2">
                              ...
                              >
                                {parseInt(pageData?.current_page - 1) * 20 + i + 1}
                              </td>
                              <td>{v?.category_details?.name}</td>
                              <td>{v?.user_type =="user"? "User":"Driver"}</td>
                              <td>{v?.coupon_code}</td>
            ...
            <div className="modal-content  w-100 " style={{ padding: "20px" }}>
              ...
              <div className="modal-body p-0">
                ...
                <input
                  className="form-control w-100 mb-2"
                  placeholder=""
                  value={editFormData?.coupon_amount}
                  onChange={(e) =>
                    setEditFormData({ ...editFormData, coupon_amount: e?.target.value })
                  }
                />
                <label>Status</label>
                <select
                ...
                {editFormData?.valid_till && editFormData?.status && editFormData?.coupon_amount ? (
                  submitLoader ? (
                    <button
...
export default GiftVouchersList;
