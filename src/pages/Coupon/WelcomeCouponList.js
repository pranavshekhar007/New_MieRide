          ...
          >
            <div style={{ margin: "20px 10px" }}>
              <div className="row my-4">
                <div className="col-2">
                  <button
                    style={{ borderRadius: "20px", border: payload?.category_id == 2 ? "2px solid #FF4500":"none"}}
                    className="btn-primary btn w-100"
                    onClick={()=>setPayload({...payload, category_id:"2"})}
                  >
                    Personal
                  </button>
                </div>
                <div className="col-2">
                  <button
                    style={{ borderRadius: "20px", border: payload?.category_id == 1 ? "2px solid #FF4500":"none" }}
                    className="btn-success btn w-100"
                    onClick={()=>setPayload({...payload, category_id:"1"})}
                  >
                    Sharing
                  </button>
                </div>
...
export default WelcomeCouponList;
