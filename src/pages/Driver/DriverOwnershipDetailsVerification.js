...
function DriverOwnershipDetailsVerification() {
      ...
      <section className="section_layout" style={{ marginLeft: globalState?.isFillSidebarWidth100 ? "260px" : "80px" }}>
        ...
        <div className="row m-0 p-0">
          <div className="col-3 m-0 p-0">
            <DriverSideNav selectedNav="Ownership" />
          </div>
            ...
            <div className="driverPopVerificationRightMain borderRadius50All">
              ...
              <div className="d-flex justify-content-center">
                {driverDetails?.ownership_image ? (
                  <Zoom>
                    <img
                      src={Image_Base_Url + driverDetails?.ownership_image}
                      style={{ height: "350px", borderRadius: "12px" , cursor:"zoom-in"}}
              ...
              <div className="row driverPopUpActionButton d-flex justify-content-around align-items-center">
                ...
                <div className="col-5">
                  {btnLoader.approve ? (
                    <button style={{ opacity: "0.5" }}>Updating ...</button>
                  ) : (
                    <button onClick={() => updateDriverFunc(true)}>Approve</button>
                  )}
                </div>
              </div>
            </div>
...
export default DriverOwnershipDetailsVerification;
