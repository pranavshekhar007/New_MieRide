...
export const getScheduledNotification = async (formData) => {
  try {
    const response = await axios.post(BASE_URL + "get-schedule-daily-notification",formData, getConfig());
    return response;
  } catch (error) {
...
export const updateScheduleNotification = async (formData) => {
  try {
    const response = await axios.post(BASE_URL + "update-schedule-daily-notification",formData, getConfig());
    return response;
  } catch (error) {
    // Handle error (e.g., log or throw an error)
    console.error("Error fetching data:", error);
...
export const createScheduleNotification = async (formData) => {
  try {
    const response = await axios.post(BASE_URL + "schedule-daily-notification",formData, getConfig());
    return response;
  } catch (error) {
    // Handle error (e.g., log or throw an error)
    console.error("Error fetching data:", error);
